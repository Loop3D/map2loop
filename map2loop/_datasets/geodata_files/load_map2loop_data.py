...
def load_hamersley_geology():
    ...
    stream = "./map2loop/_datasets/geodata_files/hamersley/geology.geojson"  
...
def load_hamersley_structure():
    ...
    path = "./map2loop/_datasets/geodata_files/hamersley/structures.geojson"
...
def load_hamersley_dtm():
    ...
    path = "./map2loop/_datasets/geodata_files/hamersley/dtm_rp.tif"
