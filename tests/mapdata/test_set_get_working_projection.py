...
@pytest.mark.parametrize(
    ...
    [
        ...
        (None, None, None, "Warning: Unknown projection set None. Leaving all map data in original projection\n"),  # error case with None
        ([], None, None, "Warning: Unknown projection set []. Leaving all map data in original projection\n"),  # error case with list
